    ...
    module NestedSet #:nodoc:
      module Columns
        ...
        def quoted_left_column_name
          active_record_connection.quote_column_name(left_column_name)
        end

        def quoted_right_column_name
          active_record_connection.quote_column_name(right_column_name)
        end

        def quoted_depth_column_name
          active_record_connection.quote_column_name(depth_column_name)
        end

        def quoted_primary_column_name
          active_record_connection.quote_column_name(primary_column_name)
        end

        def quoted_parent_column_name
          active_record_connection.quote_column_name(parent_column_name)
        end
        ...
        def quoted_order_column_name
          active_record_connection.quote_column_name(order_column)
        end
        ...
        def active_record_connection
          self.class == Class ? connection : self.class.connection
        end
      end
    end
  end
